...
const howItWorks = [
  { step: '01', title: 'Rescatamos', desc: 'Recibimos donaciones de alimentos de empresas, supermercados y particulares.', icon: ShoppingBasket, color: '#F59E0B' },
  { step: '02', title: 'Clasificamos', desc: 'Nuestro equipo y voluntarios clasifican, pesa y empaquetan los alimentos.', icon: CheckCircle2, color: '#EA580C' },
  { step: '03', title: 'Distribuimos', desc: 'Llevamos las despensas directamente a las comunidades beneficiadas.', icon: Truck, color: '#D97706' },
  { step: '04', title: 'Impactamos', desc: 'Más de 500 familias reciben alimento fresco cada mes gracias a este proceso.', icon: Users, color: '#92400E' },
];
  ...
  return (
    <>
      <SEOHead
        ...
        description="El Banco de Alimentos de Armonizando Vidas A.B.P. rescata y distribuye alimentos para familias vulnerables en Nuevo León. Dona o únete como voluntario."
        keywords="banco de alimentos, donación de alimentos, familias vulnerables, voluntarios, seguridad alimentaria, Nuevo León"
      />
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <SectionBadge color="fire" className="mb-5">Programa Social</SectionBadge>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6">
                Ninguna familia
                <br />
                <span className="gradient-text-fire">sin alimento</span>
              </h1>
              <p className="text-white/75 text-lg sm:text-xl leading-relaxed mb-8">
                Rescatamos alimentos, combatimos el desperdicio y llegamos a cientos de
                familias en situación de vulnerabilidad cada mes.
              </p>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="max-w-6xl mx-auto px-4 pb-8">
            ...
            >
              {[
                { value: 500, suffix: '+', label: 'Familias / mes' },
                { value: 12, suffix: 'T', label: 'Alimento/mes' },
                { value: 10, suffix: '', label: 'Comunidades' },
              ].map(({ value, suffix, label }) => (
                <div key={label} className="text-center p-3 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15">
      ...
      <ImageStoryBand
        ...
        title="Rescatamos alimento antes de que"
        accent="pierda su oportunidad"
        description="El Banco de Alimentos conecta excedentes en buen estado con familias que los necesitan. La clave está en actuar rápido, cuidar la calidad y distribuir con dignidad."
        image="https://images.unsplash.com/photo-1593113616828-6f22bca04804?w=1200&q=80"
        imageAlt="Personas preparando cajas de alimento para distribución"
        tone="food"
        items={[
          'Recibimos donaciones de alimentos, productos básicos y recursos para transporte.',
          'Organizamos jornadas con voluntarios para clasificar, pesar y preparar despensas.',
          'Priorizamos comunidades donde una despensa puede aliviar presión económica inmediata.',
        ]}
      />
      ...
      <section className="section-padding bg-[#FFFBF5]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <RevealOnScroll>
              <SectionBadge color="fire" className="mb-4">Cómo funciona</SectionBadge>
              <h2 className="text-4xl font-extrabold text-[#78350F] mt-2">
                Del rescate a la <span className="gradient-text-fire">mesa</span>
              </h2>
            </RevealOnScroll>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <RevealOnScroll>
            <SectionBadge color="fire" className="mb-4">Nuestro Impacto</SectionBadge>
            <h2 className="text-4xl font-extrabold text-white mb-10 mt-2">
              Números que <span className="gradient-text-fire" style={{ background: 'linear-gradient(90deg, #FEF3C7, #FCD34D)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>hablan</span>
            </h2>
          </RevealOnScroll>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              { value: 500, suffix: '+', label: 'Familias beneficiadas mensualmente' },
              { value: 12, suffix: 'T', label: 'Toneladas de alimento distribuidas' },
              { value: 10, suffix: '', label: 'Comunidades activas' },
              { value: 3, suffix: '+', label: 'Años de operación continua' },
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          <RevealOnScroll>
            ...
            <h2 className="text-4xl font-extrabold text-[#78350F] mb-4">
              Tú puedes ser parte de esta cadena
            </h2>
            <p className="text-[#92400E] text-lg mb-8 max-w-xl mx-auto">
              Dona alimentos, dinero o tu tiempo. Cada aportación alimenta a una familia real.
            </p>
