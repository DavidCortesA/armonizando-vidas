...
const images = {
  ...
  community:
    "https://images.unsplash.com/photo-1764738130353-9bf18db12109?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
const helpOptions = [
  {
    ...
    title: "Dona",
    description:
      "Contribuye para sostener nuestros programas de alimentación, formación y acompañamiento.",
  },
  {
    icon: HandHeart,
    step: "02",
    title: "Sé voluntario",
    description:
      "Ofrece tu tiempo y talento para participar directamente en nuestras acciones comunitarias.",
  },
  {
    icon: Share2,
    step: "03",
    title: "Comparte",
    description:
      "Ayúdanos a llegar a más personas difundiendo nuestra labor en tus redes y comunidades.",
  },
];
        ...
        <div className="page-container hero-carousel-content">
          ...
          >
            ...
            {currentSlide.programName && (
              <h2 className="hero-carousel-program-name">
                {currentSlide.programName}
              </h2>
            )}
          ...
          <div className="hero-carousel-navigation">
            ...
            <div
              ...
              aria-label="Seleccionar programa destacado"
            >
      ...
      >
        <div className="page-container">
          <RevealOnScroll className="mx-auto max-w-4xl text-center">
            ...
            <h2 id="titulo-nosotros" className="section-title mx-auto mt-5">
              Apoyo comunitario con propósito
            </h2>
            <p className="section-copy mx-auto mt-6 max-w-4xl">
              En Armonizando Vidas A.B.P. atendemos a personas y familias en
              situación vulnerable, a través de nuestras diferentes líneas de
              acción, brindando ayuda alimentaria, enseñanza de oficios, apoyo
              social, enseñanza de valores y la creación de espacios de
              integración comunitaria donde se capacita, enseña y dignifica la
              vida del individuo, así como de la familia.
            </p>
          </RevealOnScroll>
      ...
      >
        <div className="page-container">
          <RevealOnScroll className="mx-auto max-w-3xl text-center">
            ...
            <h2 id="titulo-programas" className="section-title mt-5">
              Nuestros programas sociales
            </h2>
            <p className="section-copy mx-auto mt-5 max-w-2xl">
              Atendemos necesidades inmediatas mientras desarrollamos
              capacidades, vínculos y oportunidades que fortalecen a cada
              persona y a su comunidad.
            </p>
          </RevealOnScroll>
          ...
          <div className="programs-grid mt-14">
            {programs.map(
              (
                { logo, title, description, image, alt, href, linkLabel },
                index,
              ) => (
                <RevealOnScroll
                  key={title}
        ...
        <div className="page-container relative z-10">
          <RevealOnScroll className="grid gap-6 md:grid-cols-[0.8fr_1.2fr] md:items-end">
            ...
            <p className="max-w-2xl text-base leading-7 text-white/70 md:justify-self-end md:text-lg">
              Cada donativo, cada voluntario y cada acción nos ayuda a llevar
              formación, alimento y esperanza a más personas.
            </p>
          </RevealOnScroll>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_0.82fr] lg:gap-16">
            <div>
              <RevealOnScroll>
                ...
                <h2 id="titulo-ayudar" className="section-title mt-5">
                  Cómo puedes ayudar
                </h2>
                <p className="section-copy mt-5 max-w-2xl">
                  Tu apoyo puede convertirse en alimento, aprendizaje y
                  acompañamiento para una familia que lo necesita.
                </p>
              </RevealOnScroll>
                      ...
                      <article className="help-card">
                        ...
                        <div>
                          <div className="flex items-center gap-3">
                            <span className="text-[10px] font-extrabold tracking-[0.18em] text-magenta">
                              {step}
                            </span>
              ...
              <div className="help-photo">
                ...
                <div className="help-photo-card">
                  <p className="font-display text-2xl font-bold italic text-ink">
                    Tu ayuda sí transforma.
                  </p>
                  <a
                    href="#contacto"
                    className="mt-5 inline-flex items-center gap-2 text-sm font-extrabold text-magenta"
                  >
                    Quiero sumarme
          ...
          <RevealOnScroll>
            <div className="contact-panel">
              ...
              <div className="relative z-10 max-w-3xl">
                ...
                <h2
                  id="titulo-contacto"
                  className="mt-6 text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-6xl"
                >
                  Juntos podemos seguir
                  <span className="block font-display font-bold italic text-gold-light">
                    armonizando vidas
                  </span>
                </h2>
                <p className="mt-6 max-w-2xl text-base leading-7 text-white/75 sm:text-lg">
                  Cada ayuda cuenta. Tu generosidad puede hacer una diferencia
                  real en Monterrey y Nuevo León.
                </p>
